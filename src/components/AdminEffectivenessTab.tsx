  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <section className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        <Card className="p-5 flex flex-col justify-between bg-slate-50/50 dark:bg-slate-900/50 border border-border shadow-sm text-center">
        ...
        <Card className="p-5 flex flex-col justify-between bg-slate-50/50 dark:bg-slate-900/50 border border-border shadow-sm text-center">
          ...
          <span className="text-3xl font-black text-primary">{data.training_effectiveness_index}%</span>
      ...
      <Card className="p-6 bg-card border border-border shadow-sm">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs text-left border-collapse">
            <thead>
              <tr className="border-b border-border text-slate-400 font-bold uppercase">
            ...
            <tbody>
              {data.high_impact_programs.map((item: any) => {
                ...
                return (
                  <tr key={item.subject_id} className="border-b border-border hover:bg-slate-50/50 dark:hover:bg-slate-850/50 transition">
