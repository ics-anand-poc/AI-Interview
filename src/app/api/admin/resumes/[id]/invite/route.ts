...
export async function POST(
  ...
  try {
    ...
    const subject =
      interviewType === "non-technical"
        ? `TalentScope — Interview Assessment - ${fullName.toUpperCase()}`
        : interviewType === "both"
          ? `TalentScope — Technical & Behavioral Assessment - ${fullName.toUpperCase()}`
          : `TalentScope — Technical Interview Assessment - ${fullName.toUpperCase()}`;
