...
# Repo was split into sibling Backend/ and Frontend/ folders; the Excel source data
# still lives under Backend/docs, but the live app data (src/data, uploads/) that this
# script reads/writes belongs to the Frontend Next.js app, not Backend.
...
ACCOUNTS_FILE = FRONTEND_ROOT / "src" / "data" / "employee-accounts.json"
LOCAL_TESTS_FILE = FRONTEND_ROOT / "uploads" / "local_tests_db.json"
MANIFEST_FILE = FRONTEND_ROOT / "uploads" / "employee_test_manifest.json"
